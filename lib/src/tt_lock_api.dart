...
/// 锁相关 Pigeon API：将 [PlatformException] 转为 [TTLockException]（见 `package:ttlock_premise_flutter/errors`）。
class TTLockApi {
  TTLockApi({
  ...
  Future<List<Map<String, Object?>>> getAllValidPasscodes(String lockData) =>
  ...
  Future<List<Map<String, Object?>>> getAllValidCards(String lockData) =>
  ...
  Future<List<Map<String, Object?>>> getAllValidFingerprints(String lockData) =>
