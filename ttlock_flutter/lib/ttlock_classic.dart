...
export 'package:ttlock_flutter_platform_interface/pigeon/messages.g.dart';

@Deprecated('Use TTLock from package:ttlock_flutter/ttlock.dart and TTLock.lock / TTLock.gateway / TTLock.doorSensor / remoteKey / remoteKeypad / waterMeter / electricMeter instead.')
class TTLock {
