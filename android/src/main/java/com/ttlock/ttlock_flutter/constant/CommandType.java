...
public class CommandType {
    ...
    /** 独立门磁（Standalone Door Sensor） */
    public static final int STANDALONE_DOOR_SENSOR = 6;
    /** 水表 */
    public static final int WATER_METER = 7;
    /** 电表 */
    public static final int ELECTRICITY_METER = 8;
